export const BlogCategoryOperationDescription = {
...
export const BlogCategoryResponseMessage = {
...
export const BlogCategoryResponseError = {
  CategoryNotFound: 'Category not found',
  CategoryExists: 'Such category already exists'
}

export const CategoryPropertiesDescription = {
